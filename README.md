...
- **Vercel Serverless Optimization**: Native ESM module resolution (`./db.js`), `/tmp` serverless SQLite database path support, and `vercel.json` file-tracing configurations.
